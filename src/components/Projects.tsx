...
const Tag: FC<{
  ...
  <button
    onClick={() => onClick(tag)}
    className={`text-xs border border-black px-2 p-0.5 flex gap-1 items-center whitespace-nowrap cursor-pointer ${isRemover ? "bg-black text-white" : "hover:bg-black hover:text-white"}`}
  >
    <span>{tag}</span>
    {isRemover && (
